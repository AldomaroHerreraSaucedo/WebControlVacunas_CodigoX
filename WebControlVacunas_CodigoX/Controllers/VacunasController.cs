...
namespace WebControlVacunas_CodigoX.Controllers
{
    public class VacunasController : Controller
    {
        ...
        public VacunasController(ControlVacunasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Vacuna vacuna)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Vacuna vacuna)
        {
            if (id != vacuna.Id)
            {
                return NotFound();
